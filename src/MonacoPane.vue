    ...
    monaco.languages.setMonarchTokensProvider('asciitex', {
      ...
      tokenizer: {
        root: [
          [/%.*/, 'comment'],
          [/\\(?:begin|end)\s*\{[^}]+\}/, 'keyword'],
          [/\\(?:section|subsection|subsubsection|title|header|footer|label|ref|cite|bibliography|bibliographystyle|includeimage|begindiagram|enddiagram|item|columnbreak|floatbarrier|hr|quote|verbatim|underbrace)\b/, 'keyword'],
