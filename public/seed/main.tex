...
\begin{longasciitable}[width=\textwidth,numbered=false,style=dashed,borders=top,bottom,header,caption="Unnumbered dashed long table"]
Border option & Effect
none & Omits table border lines entirely while preserving column spacing.
top,bottom,header & Draws only horizontal rules above, below, and after the header row.
